...
void print_sbox(unsigned char sbox[][16])
{
	int i, j;
...
inline unsigned char mul(unsigned char x, int n)
{
	unsigned char res = 0, curr = x;
	int i;
...
inline void generate_mixcol_tab_row(int multipliers[], unsigned char idx)
{
